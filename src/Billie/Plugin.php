...
class Plugin {
	...
	public function init(): void {
		...
		load_plugin_textdomain( 'billie-for-woocommerce', false, $plugin_rel_path );
    ...
    " );
		echo '<p>' . esc_html__( 'Since this order will be paid via Billie you won\'t be able to change the addresses.', 'billie-for-woocommerce' ) . '</p>';
	}
	...
	public static function get_gateway() {
		...
		throw new GatewayNotFoundException( __( 'Gateway not found', 'billie-for-woocommerce' ) );
	}
